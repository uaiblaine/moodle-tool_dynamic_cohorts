...
$string['conditionchangesnotapplied'] = 'Condition changes are not applied until you save the rule form';
...
$string['missingtag'] = 'Missing tag {$a}';
...
$string['task_process_rule'] = 'Process a dynamic cohort rule';
